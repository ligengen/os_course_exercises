...
- 请总结你认为操作系统应该具有的特征有什么？并对其特征进行简要阐述。
  ...
  并发性、共享性、虚拟性、异步性。
  并发性：计算机系统中同时存在多个正在运行的程序。
  共享性：系统中的资源可以被多个并发的进程共同使用。
  虚拟性：使用多道程序设计技术，使得每个用户都认为有一个专门的计算机为他服务。
  异步性：由于资源有限，进程以不可预知的速度向前推进。

- 为什么现在的操作系统基本上用C语言来实现？为什么没有人用python，java来实现操作系统？

  C语言性能良好，可以直接嵌入汇编使用，操作硬件方便。Python和Java性能差，而且不可以直接操作硬件。
---
